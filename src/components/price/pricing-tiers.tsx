...
export const tiers: Array<Tier> = [
  // Pay Once
  {
    ...
    features: {
      yearly: ["5 AI images (4K)", "No watermarks", "High-Res export", "Forever yours"],
      monthly: ["5 AI images (4K)", "No watermarks", "High-Res export", "Forever yours"],
      onetime: ["5 AI images (4K)", "No watermarks", "High-Res export", "Forever yours"],
    },
    buttonText: "Purchase",
    buttonColor: "default",
    buttonVariant: "flat",
  ...
  // Pro Monthly
  {
    ...
    features: {
      yearly: ["30 AI images/month (4K)", "No watermarks", "High-Res PDF export", "Typography Tool (no watermark)"],
      monthly: ["30 AI images/month (4K)", "No watermarks", "High-Res PDF export", "Typography Tool (no watermark)"],
      onetime: ["30 AI images/month (4K)", "No watermarks", "High-Res PDF export", "Typography Tool (no watermark)"],
    },
  ...
  // Pro Yearly
  {
    ...
    features: {
      yearly: ["360 AI images/year (4K)", "No watermarks", "High-Res PDF export", "Priority support"],
      monthly: ["360 AI images/year (4K)", "No watermarks", "High-Res PDF export", "Priority support"],
      onetime: ["360 AI images/year (4K)", "No watermarks", "High-Res PDF export", "Priority support"],
    },
    buttonText: "Subscribe",
    buttonColor: "default",
    buttonVariant: "flat",
