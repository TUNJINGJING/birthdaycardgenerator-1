...
export const tiers: Array<Tier> = [
  // Free
  {
    ...
    features: {
      yearly: ["3 AI cards/month", "Web quality (1K resolution)", "Personal use"],
      monthly: ["3 AI cards/month", "Web quality (1K resolution)", "Personal use"],
      onetime: ["3 AI cards/month", "Web quality (1K resolution)", "Personal use"],
    },
  ...
  // Pro (with Monthly/Yearly toggle)
  {
    ...
    features: {
      monthly: ["30 AI cards/month (4K)", "No watermarks", "High-Res export", "Commercial usage rights"],
      yearly: ["360 AI cards/year (4K)", "No watermarks", "High-Res export", "Priority support"],
      onetime: ["30 AI cards/month (4K)", "No watermarks", "High-Res export", "Commercial usage rights"],
    },
